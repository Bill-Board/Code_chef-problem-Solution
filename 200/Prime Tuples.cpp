...
bool prime[2000120];vector<v99>prm;
void SieveOfEratosthenes(v99 n)
{
	...
	for(v99 i=3;i<=n;i++)if(!prime[i] and !prime[i+2]) prm.pb(i+2);
...
void solve()
{
    /// code is here->
    v99 n;read(n);
    v99 pos=upper_bound(sob(prm),n)-prm.begin();
    print(pos);
}
